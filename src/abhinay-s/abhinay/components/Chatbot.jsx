...
const Chatbot = () => {
    ...
    const handleSubmit = useCallback(() => {
        ...
        if (route) {
            ...
            console.info('Chatbot: No matching page for query ->', query);
    ...
    return (
        <>
            ...
            <div className="max-w-2xl mx-auto border-2 rounded-[20px] border-black">
                <div className="relative bg-white rounded-3xl pt-6 pl-3">
                    ...
                    <div className="flex items-center justify-between mb-1">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <div className='flex items-center gap-1 bg-[#F0EAF4] rounded-[8px] p-1'>
