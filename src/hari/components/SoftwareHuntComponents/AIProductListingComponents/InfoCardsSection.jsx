...
const InfoCardsSection = () => {
  ...
  return (
    <>
      {/* Heading */}
      <h2 className="text-2xl md:text-4xl font-bold text-center mb-10 leading-snug">
        Then We have Everything <br />
        You Need to Make <br />
        The Right Decision in One Place
      </h2>

      <div className="relative bg-white py-10 px-4 md:px-8 lg:px-20 overflow-hidden">
        {/* Wavy background */}
        <img
          src="/hari/SoftwareHuntImages/wavygreen.png"
          alt="Wavy Background"
        ...
        ${index % 2 === 0 ? "lg:translate-y-4" : "lg:-translate-y-4"}`}
            >
              <div className="flex justify-between items-center mb-2">
                ...
                <div className="bg-[#14A79D] p-1.5 rounded-full">{card.icon}</div>
              </div>
