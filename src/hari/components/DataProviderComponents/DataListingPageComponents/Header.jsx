  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage: 'url(/hari/DataProviderImages/listingBanner.jpg)',
        }}
      >
        <div className='m-4'>
          {/* Top Row */}
          ...
          <p className="mt-2 text-sm lg:text-base leading-relaxed text-white">
            Company data includes essential details about businesses like name, location and industry. Here you’ll<br />
            find a guide and our selection of top company data sources, where you can explore databases and compare<br />
            providers.
          </p>
