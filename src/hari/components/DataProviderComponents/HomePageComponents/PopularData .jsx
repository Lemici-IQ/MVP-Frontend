...
const PopularData = () => {
    ...
    return (
        <section className="max-w-7xl mx-auto px-6 py-12">
            {/* Header */}
            <div className="mb-10">
                <h2 className="text-3xl font-semibold text-gray-900">Popular Data</h2>
                <p className="text-gray-600 text-sm mt-2">
                    Find the right strategic data for your business & Compare more than 2000+
                </p>
            </div>
                        ...
                        <div className="flex items-center justify-between px-4 pt-3 text-sm">
                            <div className="flex items-center gap-2">
                                <div className="w-5 h-5 bg-gray-200 rounded-full overflow-hidden">
                                    <img src="/hari/DataProviderImages/ukflag.png" alt="flag" className="w-full h-full" />
                                </div>
                        ...
                        <div className="p-5">
                            ...
                            <div className="flex items-center gap-3 mb-2">
                                <div className="w-10 h-10 bg-gray-200 rounded-md overflow-hidden">
                                    <img src="/hari/DataProviderImages/cardlogo.jpg" alt="logo" className="w-full h-full" />
                                </div>
                                <div>
                            ...
                            {/* Description */}
                            <p className="text-gray-600 text-sm leading-snug mb-2">{card.description}</p>
