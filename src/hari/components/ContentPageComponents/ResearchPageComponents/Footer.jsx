      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-8">
        ...
        <div className="flex flex-col items-start w-full md:w-1/2">
          <h3 className="text-lg font-medium mb-4 flex items-center gap-2">
            <FaLightbulb className="text-[#6D3E93]" /> Follow on Socials
          </h3>
        ...
        <div className="flex items-center bg-gray-100 rounded-full px-4 py-2 w-full md:w-1/2 max-w-md">
          ...
          />
          <button className="bg-[#6D3E93] hover:bg-[#5B2E7E] text-white p-2 rounded-full transition">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
        <div>
          <h4 className="font-semibold mb-3 flex items-center gap-2">
            <FaEnvelope className="text-[#6D3E93]" /> Contact
          </h4>
        ...
        <div>
          <h4 className="font-semibold mb-3 flex items-center gap-2">
            <FaBriefcase className="text-[#6D3E93]" /> Careers
          </h4>
          <ul className="space-y-2 text-sm">
            <li>Why LeMiCi</li>
        ...
        <div>
          <h4 className="font-semibold mb-3 flex items-center gap-2">
            <FaBook className="text-[#6D3E93]" /> Resources
          </h4>
          <ul className="space-y-2 text-sm">
        ...
        <div>
          <h4 className="font-semibold mb-3 flex items-center gap-2">
            <FaLightbulb className="text-[#6D3E93]" /> What We Do
          </h4>
          <ul className="space-y-2 text-sm">
