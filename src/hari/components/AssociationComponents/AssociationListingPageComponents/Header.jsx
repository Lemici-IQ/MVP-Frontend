  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage: 'url(/hari/AssociationImages/ListingHeader.png)',
        }}
      >
        ...
        <div className='relative z-10 m-4'>
          ...
          <p className="mt-2 text-sm lg:text-base leading-relaxed text-white">
            Business associations are organizations where businesses within a specific industry or sector come together to promote and protect their
            collective interests. These associations provide a platform for networking, sharing information, and advocating for policies that benefit their
            members. They can also act as a collective voice for their industry, influencing public policy and promoting best practices.
          </p>
        ...
        <div className="absolute bottom-4 right-6 flex items-center gap-2 text-white z-10">
